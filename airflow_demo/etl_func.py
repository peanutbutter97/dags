...
def init_writer(
    ...
    pa_schema: pa.Schema,
    batch_num: int = 0,
) -> Tuple[pa.ipc.RecordBatchFileWriter, pa.S3FileSystem, str]:
    """
    ...
    try:
        ...
        s3_fs = pa.S3FileSystem(region="ap-southeast-01").open_output_stream(s3_path)
...
def read_arrow_s3(s3_path: str, region: str = "ap-southeast-1") -> pa.Table:
    ...
    try:
        ...
        s3_fs = pa.S3FileSystem(region=region).open_input_file(s3_path)
